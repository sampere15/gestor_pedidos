...
@section('content')
	<h2>Creación de una nueva categoría</h2>

	<div class="row">
		<form class="form-horizontal" method="POST" action="{{ route('categorias.guardar') }}">
			<div class="col-md6 col-sm-6 col-xs-12">
	            ...
	            <button type="submit" id="btnCrearCampo" class="btn btn-lg btn-success pull-right">Crear categoría</button>
	        </div>
		</form>
	</div>
@endsection
