...
@section('content')
	...
	<div class="row">
		<form class="form-horizontal" method="POST" action="{{ route('campos.crear') }}">
			<div class="col-md6 col-sm-6 col-xs-12">
	            ...
	            <div class="form-group{{ $errors->has('abreviatura') ? ' has-error' : '' }}">
	                ...
	                <div class="col-md-10">
	                    <input id="inputAbreviatura" type="text" class="form-control" name="abreviatura" placeholder="Abreviatura" required value="{{ old('abreviatura') }}">
	            ...
	            <hr>
	            <h4>Sociedades que gestionan este campo</h4>
        		@foreach ($sociedades as $sociedad)
	            	<div class="row">
                        <label>
                            <input type="checkbox" name="sociedades[]" value="{{ $sociedad->id }}"> {{ $sociedad->nombre }}
                        </label>
                	</div>
        		@endforeach
                ...
                <hr>
                <h3>Dirección del nuevo campo</h3>
    			<div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                ...
                <div class="form-group{{ $errors->has('codigo_postal') ? ' has-error' : '' }}">
                    <label for="inputCodigoPostal" class="col-md-3 control-label">Código Postal</label>
                    <div class="col-md-9">
                        <input id="inputCodigoPostal" size="255" type="text" class="form-control" name="codigo_postal" placeholder="Código Postal" required value="{{ old('codigo_postal') }}">
                ...
                <div class="form-group{{ $errors->has('pais') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-9">
                        <input id="inputPais" size="255" type="text" class="form-control" name="pais" placeholder="País" required value="{{ old('pais') }}">
                ...
                <div class="form-group{{ $errors->has('numero_contacto') ? ' has-error' : '' }}">
                    <label for="inputNumeroContacto" class="col-md-3 control-label">Número Contacto</label>
                    <div class="col-md-9">
                        <input id="inputNumeroContacto" size="255" type="text" class="form-control" name="numero_contacto" placeholder="Número Contacto" required value="{{ old('numero_contacto') }}">
	            ...
	            <button type="submit" id="btnCrearCampo" class="btn btn-lg btn-success pull-right">Crear campo</button>
	        </div>
		</form>
	</div>
@endsection