...
@push('footscripts')
    ...
    <script type="text/javascript">
		...
		function ActualizarCampos()
		{
			...
			//	Si el usuario tiene disponible más de un campo (en general) comprobaremos entonces los que tiene disponibles para ese campo.
			//	Dampos por hecho que si tiene sólo un campo será para ese departamento
			if(campos.length > 1)
			{
		...
		function ActualizarSelectCampos()
		{
			...
			{
				html += "<option value='" + campos[i]['id'] + "' selected='true'>" + campos[i]['nombre'] + "</option>";
			}
